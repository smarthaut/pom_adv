...
class Picture(Basepage):
    ...
    def rec_specific_page_input(self):
        ...
        return self.find_element('xpath=>//div[@id="content_container"]/div[@class="panel_container"]/div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tfoot/tr/td/table/tbody/tr/td[2]/input')
    
    def rec_next_page_btn(self):
        self.logger = logging.getLogger(__name__)
        self.logger.debug(u'找到"NextPage"按钮.')

        return self.find_element('xpath=>//div[@id="content_container"]/div[@class="panel_container"]/div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tfoot/tr/td/table/tbody/tr/td[13]')
    ...
    def rec_new_create_ad_info(self):       
        ...
        trs = self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr')
        num = 0
        for tr in trs:
        ...
        ad_id =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[1]' % num ).text
        self.logger.debug(u'新创广告位id为  %s".'  % ad_id)  
        picture_info.append( ad_id )
        
        ad_name =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[2]' % num ).text
        picture_info.append( ad_name )
        
        ad_size =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[3]' % num ).text
        picture_info.append( ad_size )
          
        ad_creater =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[4]' % num ).text
        picture_info.append( ad_creater ) 
        
        ad_modify_time =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[5]' % num ).text
        picture_info.append( ad_modify_time ) 
        
        ad_number =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[6]' % num ).text
...
class Video(Basepage):
    ...
    def rec_new_create_material_info(self):       
        ...
        ad_author =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[2]' % num ).text
        material_info.append( ad_author )
        
        movie_number =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[3]' % num ).text
        material_info.append(  movie_number ) 
        
        ad_modify_time =  self.find_element('xpath=>//div[@class="panel_page_list_container"]/div[@id="adPos_position_list"]/table/tbody/tr[%s]/td[4]' % num ).text
...
class CreateAdPostionForPicture(Basepage):
    ...
    def receive_match_down_menu(self):
        ...
        return self.find_element('xpath=>//div[@id="adPos_dialog_ne_adapt_selector"]/div[@class="styled-selector-dropicon"]/div[@class="styled-selector-down-arrow"]')
    
    def _click_match_down_menu(self):
        self.receive_match_down_menu().click()
        return self.find_element('xpath=>//div[@class="panel_dialog_block"]/div[@id="adPos_dialog_ne_adapt_selector"]/div[@class="styled-selector-dropbox"]/table')
    ...
    def _click_default_ad_down_menu(self):
        ...
        return self.find_element('xpath=>//div[@id="adPos_dialog_ne_dfAd_selector"]/div[@class="styled-selector-dropbox"]/table')
...
class CreateAdPostionForVideo(Basepage):
    ...
    def receive_default_ad_down_menu(self):
        self.logger = logging.getLogger(__name__)
        self.logger.debug(u'找到"默认广告"下拉控件.')
        return self.find_element('xpath=>//div[@class="panel_dialog_block"]/div[@id="adPos_dialog_ne_dfAd_selector"]/div[@class="styled-selector-dropicon"]/div[@class="styled-selector-down-arrow"]')
